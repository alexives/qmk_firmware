...
#define TG_NAV  TO(_NAV) // Toggle Nav Layer
...
#define SK_OSHY OSM(KC_HYPER)    // One shot hyper key
...
[_LOWER] = {
  ...
  {KC_SLEP, _______, _______, _______, _______, _______, _______, LC_LGUI, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
...
[_RAISE] = {
  ...
  {KC_SLEP, _______, _______, _______, _______, _______, _______, _______, _______, BL_DEC,  BL_INC,  BL_TOGG}
},
...
[_NAV] = {
  ...
  {_______, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TO_WKMN},
 ...
 */
[_ADJUST] = {
  {RESET,   TO_QWTY, TO_WKMN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SK_VRSN},
